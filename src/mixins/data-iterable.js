...
export default {
  ...
  data () {
    return {
      ...
      expanded: {},
      actionsClasses: 'vc@data-iterator__actions',
      actionsRangeControlsClasses: 'vc@data-iterator__actions__range-controls',
      actionsSelectClasses: 'vc@data-iterator__actions__select',
      actionsPaginationClasses: 'vc@data-iterator__actions__pagination',
    }
  },

  mixins: [Filterable, Loadable],
  ...
  methods: {
    ...
    genPrevIcon() {
      ...
      }, [this.$createElement('vt@icon', 'chevron-left')]);
    },
    genNextIcon() {
      ...
      }, [this.$createElement('vt@icon', 'chevron-right')]);
    },
    genSelect() {
