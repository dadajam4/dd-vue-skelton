...
export default {
  ...
  computed: {
    ...
    classes () {
      return {
        'vc@tooltip--top': this.top,
        'vc@tooltip--right': this.right,
        'vc@tooltip--bottom': this.bottom,
        'vc@tooltip--left': this.left
      }
    },
    computedTransition () {
  ...
  render (h) {
    const tooltip = h('div', {
      staticClass: 'vc@tooltip__content',
      'class': this.addColorClasses({
        [this.contentClass]: true,
        'vc@menuable__content__active': this.isActive
      }),
      style: this.styles,
      attrs: this.attrs,
      directives: [{
