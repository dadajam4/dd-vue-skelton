import ExpandTransitionGenerator from '~/components/transitions/expand-transition';
    ...
    genExpandedRow(props) {
      ...
      if (this.isExpanded(props.item)) {
        const expand = this.$createElement('div', {
          class: 'vc@datatable__expand-content',
      ...
      const transition = this.$createElement('transition-group', {
        class: 'vc@datatable__expand-col',
        attrs: { colspan: '100%' },
        props: {
          tag: 'td',
        },
      ...
      return this.genTR([transition], { class: 'vc@datatable__expand-row' })
    },
    genFilteredItems() {
