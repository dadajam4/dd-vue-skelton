...
export default {
  ...
  computed: {
    classes() {
      return {
        'vc@input-group--slider': true,
        'vc@input-group--active': this.isActive,
        'vc@input-group--dirty': this.inputWidth > 0,
  ...
  mounted() {
    ...
    //   console.warn('Missing vt@app or a non-body wrapping element with the [data-app] attribute', this)
  },
  ...
  methods: {
    ...
    genThumbLabel(h) {
      return h('vt@scale-transition', {
        ...
        h('div', {
          staticClass: 'vc@slider__thumb--label__container',
          directives: [
            {
              name: 'show',
              value: this.isActive,
    ...
    genSteps(h) {
      ...
      return h('div', {
        staticClass: 'vc@slider__ticks-container',
    ...
    genTrackContainer(h) {
      ...
      return h('div', {
        staticClass: 'vc@slider__track__container',
        ref: 'track',
      }, children)
    }
  },
